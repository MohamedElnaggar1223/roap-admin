								...
								<TableRow key={city.id.toString() + city.name + city.state}>
									...
									<TableCell>
										<div className="flex space-x-2 items-center justify-end">
											<Button onClick={() => router.push(`/cities/${city.id.toString()}/edit`)} className='flex items-center justify-center gap-2' variant="outline">
												<Edit />
												Edit
											</Button>
											<Button onClick={() => router.push(`/cities/${city.id.toString()}/view`)} className='flex items-center justify-center gap-2' variant="outline">
												<Eye />
												View
											</Button>
										</div>
